...
// Custom Blend Modes
constexpr std::size_t RLGL_SRC_ALPHA { 0x0302 };
constexpr std::size_t RLGL_MIN       { 0x8007 };
constexpr std::size_t RLGL_MAX       { 0x8008 };

constexpr int MAX_BOXES { 20 };
constexpr int MAX_SHADOWS { MAX_BOXES*3 };     // MAX_BOXES*3 - Each box can cast up to two shadow volumes for the edges it is away from, and one for the box itself
